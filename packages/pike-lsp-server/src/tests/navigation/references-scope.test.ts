...
write(sharedName);`;
      ...
      const { references } = setupScopeTest({
        ...
        extraDocs: new Map([
          [
            'file:///workspace/other.pike',
            TextDocument.create('file:///workspace/other.pike', 'pike', 1, otherPikeCode),
          ],
        ]),
...
int value = helper();`;
      ...
      const { references } = setupScopeTest({
        ...
        extraDocs: new Map([
          [
            'file:///workspace/Helper.pmod',
            TextDocument.create('file:///workspace/Helper.pmod', 'pike', 1, pmodCode),
          ],
        ]),
        extraCacheEntries: new Map([
          [
...
processData();`;
      ...
      const { references } = setupScopeTest({
        ...
        extraDocs: new Map([
          [
            'file:///lib/utils.pike',
            TextDocument.create('file:///lib/utils.pike', 'pike', 1, otherCode),
          ],
        ]),
        extraCacheEntries: new Map([
          [
...
int result = calculate();`;
      ...
      const { references } = setupScopeTest({
        ...
        extraDocs: new Map([
          [
            'file:///project/Consumer.pike',
            TextDocument.create('file:///project/Consumer.pike', 'pike', 1, consumerCode),
          ],
        ]),
        extraCacheEntries: new Map([
          [
...
Handler h = Handler();`;
      ...
      const { references } = setupScopeTest({
        ...
        symbolPositions: new Map([['Handler', [{ line: 0, character: 6 }]]]),
        extraDocs: new Map([
          [
            'file:///modules/ModuleB.pmod',
            TextDocument.create('file:///modules/ModuleB.pmod', 'pike', 1, moduleBCode),
          ],
        ]),
        extraCacheEntries: new Map([
          [
  ...
  describe('Scenario 4: Module functions found in workspace', () => {
    it('should find module function references in consumer files', async () => {
      ...
      const { references } = setupScopeTest({
        ...
        symbolPositions: new Map([['format', [{ line: 0, character: 7 }]]]),
        extraDocs: new Map([
          [
            'file:///app/main.pike',
            TextDocument.create('file:///app/main.pike', 'pike', 1, consumerCode),
          ],
        ]),
        extraCacheEntries: new Map([
          [
...
int x = pi;`;
      ...
      const { references } = setupScopeTest({
        ...
        extraDocs: new Map([
          [
            'file:///modules/Math.pmod',
            TextDocument.create('file:///modules/Math.pmod', 'pike', 1, pmodCode),
          ],
        ]),
        extraCacheEntries: new Map([
          [
...
int result = process();`;
      ...
      const { references } = setupScopeTest({
        ...
        extraDocs: new Map([
          [
            'file:///tools/util.pike',
            TextDocument.create('file:///tools/util.pike', 'pike', 1, pikeCode),
          ],
        ]),
        extraCacheEntries: new Map([
          [
