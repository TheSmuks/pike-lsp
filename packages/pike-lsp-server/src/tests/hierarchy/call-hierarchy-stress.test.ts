  ...
  describe('2. Branching Call Trees', () => {
    it('should handle branching call tree', () => {
      ...
      const functions: FunctionInfo[] = [
        {
          name: 'root',
          outgoingCalls: ['branch1', 'branch2', 'branch3'],
          incomingCalls: [],
          isRecursive: false,
          file: 'test.pike',
        },
  ...
  describe('3. Diamond Call Pattern', () => {
    ...
    it('should handle complex diamond with multiple levels', () => {
      ...
      const functions: FunctionInfo[] = [
        ...
        {
          name: 'C',
          outgoingCalls: ['shared2'],
          incomingCalls: ['shared1'],
          isRecursive: false,
          file: 'test.pike',
        },
        {
  ...
  describe('2. Large Graph Performance', () => {
    ...
    it('should handle concurrent hierarchy requests', () => {
      ...
      const promises = Array(10)
        .fill(null)
        .map(() => Promise.resolve(getOutgoingCallsRecursive(graph, 'func0')));
  ...
  describe('2. Cross-File Patterns', () => {
    ...
    it('should handle multiple files calling same function', () => {
      ...
      const shared: FunctionInfo = {
        name: 'shared',
        outgoingCalls: [],
        incomingCalls: ['caller1', 'caller2', 'caller3'],
        isRecursive: false,
        file: 'lib.pike',
      };
      const functions: FunctionInfo[] = [
  ...
  describe('4. Stdlib-Like Patterns', () => {
    it('should handle stdlib method calls', () => {
      ...
      const functions: FunctionInfo[] = [
        ...
        {
          name: 'array_map',
          outgoingCalls: ['myCallback'],
          incomingCalls: ['userCode'],
          isRecursive: false,
          file: 'stdlib.pike',
        },
        {
