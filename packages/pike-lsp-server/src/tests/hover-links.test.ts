...
describe('Hover Links', () => {
  it('should generate documentation link for top-level module', () => {
    ...
    assert.ok(
      markdown?.includes(
        '[Online Documentation](https://pike.lysator.liu.se/generated/manual/modref/ex/predef_3A_3A/Stdio.html)'
      )
    );
  });
  ...
  it('should generate documentation link for class in module', () => {
    ...
    assert.ok(
      markdown?.includes(
        '[Online Documentation](https://pike.lysator.liu.se/generated/manual/modref/ex/predef_3A_3A/Stdio/File.html)'
      )
    );
  });
  ...
  it('should generate documentation link for method in class', () => {
    ...
    assert.ok(
      markdown?.includes(
        '[Online Documentation](https://pike.lysator.liu.se/generated/manual/modref/ex/predef_3A_3A/Stdio/File/read.html)'
      )
    );
  });
