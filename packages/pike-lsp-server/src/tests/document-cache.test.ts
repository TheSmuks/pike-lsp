...
describe('DocumentCache - Version Tracking', () => {
  ...
  it('should preserve other entry properties on update', () => {
    ...
    const symbols = [
      { name: 'test', kind: 'method', modifiers: [], position: { line: 1, column: 1 } },
    ] as any;
    ...
    const symbols = [
      {
        ...
        children: [{ name: 'localVar', kind: 'variable', position: { line: 11, column: 5 } }],
      },
    ] as any;
        ...
        children: [
          {
            ...
            children: [{ name: 'localVar', kind: 'variable', position: { line: 3, column: 9 } }],
          },
        ],
      },
    ] as any;
