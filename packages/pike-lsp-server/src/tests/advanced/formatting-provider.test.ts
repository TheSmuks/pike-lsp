...
describe('Formatting Provider', () => {
  ...
  describe('Scenario 20.4: Formatting - Configuration', () => {
    ...
    it('should validate insertSpaces parameter', () => {
      ...
      expect(() => validateFormattingOptions({ insertSpaces: 'yes' })).toThrow(ResponseError);
    });
    ...
    it('should validate tabSize range (1-16)', () => {
      ...
      // Invalid range
      expect(() => validateFormattingOptions({ tabSize: 0 })).toThrow(ResponseError);
      expect(() => validateFormattingOptions({ tabSize: 17 })).toThrow(ResponseError);
    });
  });
  ...
  describe('Error Handling', () => {
    it('should validate tabSize type', () => {
      expect(() => validateFormattingOptions({ tabSize: '4' })).toThrow(ResponseError);
    });

    it('should validate tabSize parameter range', () => {
      // Negative
      expect(() => validateFormattingOptions({ tabSize: -1 })).toThrow(ResponseError);
      // Zero
      expect(() => validateFormattingOptions({ tabSize: 0 })).toThrow(ResponseError);
      // Too large
      expect(() => validateFormattingOptions({ tabSize: 100 })).toThrow(ResponseError);
    });

    it('should validate insertSpaces parameter type', () => {
      expect(() => validateFormattingOptions({ insertSpaces: 1 })).toThrow(ResponseError);
      expect(() => validateFormattingOptions({ insertSpaces: 'true' })).toThrow(ResponseError);
    });
  });
