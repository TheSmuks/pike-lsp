...
describe('Configuration Handling', () => {
  ...
  describe('Scenario 25.1: Config Changes - Diagnostic delay', () => {
    ...
    it('should use new delay for subsequent changes', () => {
      ...
      assert.equal(
        typeof defaultSettings.diagnosticDelay,
        'number',
        'Diagnostic delay should be a number'
      );
    });
    ...
    it('should default to 250ms if not configured', () => {
      ...
      assert.equal(
        defaultSettings.diagnosticDelay,
        250,
        'Default settings should have 250ms delay'
      );
    });
  });
  ...
  describe('Scenario 25.2: Config Changes - Revalidation', () => {
    ...
    it('should handle diagnostic config changes', () => {
      ...
      assert.equal(
        typeof defaultSettings.maxNumberOfProblems,
        'number',
        'maxNumberOfProblems should be a number'
      );
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing configuration sections', () => {
      ...
      assert.ok(
        'maxNumberOfProblems' in defaultSettings,
        'Should have maxNumberOfProblems default'
      );
  ...
  describe('Configuration Schema', () => {
    ...
    it('should validate configuration against schema', () => {
      ...
      assert.equal(
        typeof settings.maxNumberOfProblems,
        'number',
        'maxNumberOfProblems should be number'
      );
    ...
    it('should provide schema for client IntelliSense', () => {
      ...
      assert.ok(
        'PikeSettings' in types || 'defaultSettings' in types,
        'Should export settings type'
      );
    });
  });
  ...
  describe('Configuration Priority', () => {
    ...
    it('should merge configuration from all sources', () => {
      ...
      assert.equal(
        customSettings.diagnosticDelay,
        250,
  ...
  describe('Specific Configuration Options', () => {
    it('should handle maxNumberOfProblems configuration', () => {
      ...
      assert.equal(
        ...
        100,
        'Default maxNumberOfProblems should be 100'
      );
    });
