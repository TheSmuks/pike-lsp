...
describe('Symbol Resolution Tests', () => {
  ...
  describe('Symbol Navigation', () => {
    ...
    it('should find symbol in nested structure', () => {
      const symbols = {
        MyClass: {
          children: [{ name: 'innerMethod', kind: 'method' }],
        },
      };
  ...
  describe('Symbol Scope Resolution', () => {
    it('should resolve local symbol', () => {
      const scopes = [{ name: 'localVar', scope: 'function' }];
    ...
    it('should resolve class member', () => {
      const classScope = {
        name: 'MyClass',
        kind: 'class',
        members: [{ name: 'memberVar', kind: 'variable' }],
      };
    ...
    it('should handle global scope', () => {
      const globalSymbols = [{ name: 'GlobalClass', kind: 'class', scope: 'global' }];
