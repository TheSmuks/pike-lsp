...
class TestableWorkspaceIndex extends WorkspaceIndex {
  ...
  addTestDocument(
    ...
    const uriToSymbols = (this as unknown as { uriToSymbols: Map<string, Set<string>> })
      .uriToSymbols;
...
describe('Workspace Symbol Provider Stress Tests', () => {
  ...
  describe('2. Many Symbols Per Document', () => {
    ...
    it('should handle document with very long symbol names', () => {
      ...
      index.addTestDocument('file:///long.pike', [{ name: longName, kind: 'method', line: 1 }]);
  ...
  describe('7. Edge Cases and Error Handling', () => {
    ...
    it('should handle query with only whitespace', () => {
      ...
      index.addTestDocument('file:///ws.pike', [{ name: 'func', kind: 'method', line: 1 }]);
    ...
    it('should handle document removal', () => {
      ...
      index.addTestDocument('file:///remove.pike', [{ name: 'toRemove', kind: 'method', line: 1 }]);
    ...
    it('should handle very large line numbers', () => {
      ...
      index.addTestDocument('file:///large.pike', [{ name: 'symbol', kind: 'method', line: 100 }]);
