...
describe('Document Symbol Provider', () => {
  ...
  describe('Scenario 11.5: Document symbols - constants', () => {
    it('should show constant symbol', async () => {
      const { documentSymbol } = setup({
        symbols: [sym('MAX_VALUE', 'constant', { position: { file: 'test.pike', line: 1 } })],
      });
  ...
  describe('Scenario 11.6: Document symbols - typedef', () => {
    it('should show typedef symbol', async () => {
      const { documentSymbol } = setup({
        symbols: [sym('StringFunc', 'typedef', { position: { file: 'test.pike', line: 1 } })],
      });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle symbols with special characters in name', async () => {
      const { documentSymbol } = setup({
        symbols: [sym('my_variable_123', 'variable', { position: { file: 'test.pike', line: 1 } })],
      });
    ...
    it('should default line to 0 when position is missing', async () => {
      const { documentSymbol } = setup({
        symbols: [sym('noPosition', 'variable')],
      });
  ...
  describe('Symbol properties', () => {
    ...
    test.todo(
      'not applicable to Pike: protected/private modifiers not reflected in DocumentSymbol'
    );
  });
  ...
  describe('Scenario 11.9: Document symbols - Roxen module integration', () => {
    it('should enhance Roxen module symbols with defvar children', async () => {
            ...
            variables: [
              {
                name: 'my_config',
                type: 'TYPE_STRING',
                name_string: 'My Config',
                doc_str: 'Config variable',
                position: { line: 3, column: 1 },
              },
              {
                name: 'debug_mode',
                type: 'TYPE_FLAG',
                name_string: 'Debug Mode',
                doc_str: 'Debug flag',
      ...
      const mockDocuments = new Map([[uri, TextDocument.create(uri, 'pike', 0, testCode)]]);

      const { documentSymbol } = setup({
        symbols: [sym('MyModule', 'class', { position: { file: 'test.pike', line: 1 } })],
        bridge: mockBridge,
    ...
    it('should extract RXML tags from multiline strings', async () => {
      ...
      const { documentSymbol } = setup({
        symbols: [sym('MyTag', 'class', { position: { file: 'test.pike', line: 1 } })],
        bridge: mockBridge,
        documents: mockDocuments,
      });
