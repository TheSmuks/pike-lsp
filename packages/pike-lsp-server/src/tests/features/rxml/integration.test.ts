...
describe('RXML Feature Integration', () => {
  describe('Feature registration', () => {
    test('registerRXMLHandlers function exists and is exported', () => {
      assert.ok(
        typeof registerRXMLHandlers === 'function',
        'registerRXMLHandlers should be a function'
      );
    });
  ...
  describe('Feature exports', () => {
    test('RXML feature index exports all required functions', async () => {
      ...
      assert.ok(
        typeof rxmlModule.registerRXMLHandlers === 'function',
        'Should export registerRXMLHandlers'
      );
      assert.ok(
        typeof rxmlModule.provideRXMLCompletions === 'function',
        'Should export provideRXMLCompletions'
      );
      assert.ok(
        typeof rxmlModule.parseRXMLTemplate === 'function',
        'Should export parseRXMLTemplate'
      );
      assert.ok(typeof rxmlModule.getTagInfo === 'function', 'Should export getTagInfo');
      assert.ok(
        typeof rxmlModule.RXML_TAG_CATALOG !== 'undefined',
        'Should export RXML_TAG_CATALOG'
      );
    });
    ...
    test('RXML completion functions are exported', async () => {
      ...
      assert.ok(
        typeof rxmlModule.getTagCompletions === 'function',
        'Should export getTagCompletions'
      );
      assert.ok(
        typeof rxmlModule.getAttributeCompletions === 'function',
        'Should export getAttributeCompletions'
      );
    });
    ...
    test('RXML parser functions are exported', async () => {
      ...
      assert.ok(
        typeof rxmlModule.getTagAttributes === 'function',
        'Should export getTagAttributes'
      );
    });
  });
