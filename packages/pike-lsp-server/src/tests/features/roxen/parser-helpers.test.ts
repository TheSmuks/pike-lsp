...
describe('Parser Helpers', () => {
  ...
  describe('comparePositions', () => {
    ...
    it('should return -1 when a is before b', () => {
      assert.strictEqual(
        comparePositions({ line: 0, character: 5 }, { line: 1, character: 0 }),
        -1
      );
    });
    ...
    it('should compare by character when lines are equal', () => {
      assert.strictEqual(
        comparePositions({ line: 1, character: 10 }, { line: 1, character: 5 }),
        1
      );
      assert.strictEqual(
        comparePositions({ line: 1, character: 2 }, { line: 1, character: 5 }),
        -1
      );
    });
  });
