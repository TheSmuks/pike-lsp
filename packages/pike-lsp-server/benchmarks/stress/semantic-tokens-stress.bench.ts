...
function setup(opts: SetupOptions) {
  ...
  return {
    ...
    getTokensDelta: () =>
      conn.semanticTokensDeltaHandler({ textDocument: { uri }, previousResultId: 'previous' }),
    uri,
    doc,
  };
}
...
void func() {
    ...
    it('should handle same variable name at multiple scopes', () => {
      const symbols = [sym('counter', 'variable', { position: { line: 1, character: 4 } })];
...
for (int i = 0; i < 10; i++) {
  ...
  describe('High occurrence counts', () => {
    it('should handle 50+ variable occurrences', () => {
      const symbols = [sym('target', 'variable', { position: { line: 1, character: 4 } })];
    ...
    it('should handle 100+ variable occurrences', () => {
      const symbols = [sym('item', 'variable', { position: { line: 1, character: 4 } })];
...
describe('Semantic Tokens Stress: Functions', () => {
  describe('Function declarations', () => {
    ...
    it('should handle function with many parameters', () => {
      const symbols = [sym('process', 'method', { position: { line: 1, character: 4 } })];
    ...
    it('should handle recursive function', () => {
      const symbols = [sym('factorial', 'method', { position: { line: 1, character: 4 } })];
...
processing();`;
  ...
  describe('Function calls', () => {
    it('should handle 50+ function calls', () => {
      const symbols = [sym('process', 'method', { position: { line: 1, character: 6 } })];
...
class Level3 { inherit Level2; }`;
  ...
  describe('Class instances', () => {
    it('should handle many class instances', () => {
      const symbols = [sym('Handler', 'class', { position: { line: 1, character: 6 } })];
      const lines = ['class Handler { }'];
      for (let i = 0; i < 30; i++) {
...
/* target is also mentioned here */`;
    ...
    it('should not tokenize symbols inside strings', () => {
      const symbols = [sym('message', 'variable', { position: { line: 1, character: 7 } })];
...
write("The message is: %s\\n", message);`;
  ...
  describe('Special characters', () => {
    it('should handle Pike-specific operators', () => {
      const symbols = [sym('obj', 'variable', { position: { line: 1, character: 7 } })];
...
string v = map["key"];`;
  ...
  describe('Unicode and special identifiers', () => {
    it('should handle unicode in comments (non-tokenized)', () => {
      const symbols = [sym('value', 'variable', { position: { line: 1, character: 4 } })];
      const code = `int value = 1;
...
value = value + 1;`;
  ...
  it('should scale linearly with file size', () => {
    ...
    for (const size of [100, 500, 1000]) {
      const symbols = [sym('x', 'variable', { position: { line: 1, character: 4 } })];
      const lines = ['int x = 0;'];
      for (let i = 0; i < size; i++) {
        lines.push(`x = x + ${i};`);
      }
