...
function createMockConnection(): MockConnection {
  ...
  return {
    onSignatureHelp(handler: SignatureHelpHandler) {
      _handler = handler;
    },
...
greet(|`,
        symbols: [method('greet', [{ name: 'name', type: 'string' }], 'void')],
      });
...
processArray(|`,
        symbols: [method('processArray', [{ name: 'arr', type: 'array' }], 'void')],
      });
...
processMapping(|`,
        symbols: [method('processMapping', [{ name: 'data', type: 'mapping' }], 'void')],
      });
...
transform(|`,
        symbols: [method('transform', [{ name: 'data', type: 'array' }], 'void')],
      });
...
f->read(|`,
        symbols: [method('read', [{ name: 'num_bytes', type: 'int' }], 'string')],
      });
...
apply(lambda(int x) { return x * 2; }|`,
        symbols: [method('apply', [{ name: 'fn', type: 'function' }], 'void')],
      });
...
test(|`,
        symbols: [method('test', [{ name: 'x', type: 'int' }], 'void')],
      });
...
my_function_name(|`,
        symbols: [method('my_function_name', [{ name: 'param_one', type: 'int' }], 'void')],
      });
...
process2(|`,
        symbols: [method('process2', [{ name: 'x', type: 'int' }], 'void')],
      });
...
manyParams(|`,
        symbols: [method('manyParams', manyArgs, 'void')],
      });
