...
export class PikeBridge extends EventEmitter {
  ...
  private buildResponseResult(response: PikeResponse): unknown {
    ...
    if (this.isAnalyzeResponse(response)) {
      ...
      const fullResponse = {
        result,
        failures:
          (response as PikeResponse & { failures?: Record<string, unknown> }).failures || {},
        _perf: perf,
      };
  ...
  async resolveInclude(
    ...
    return this.sendRequest<import('./types.js').IncludeResolveResult>(
      'resolve_include',
      {
        includePath,
        currentFile: currentFile || undefined,
  ...
  async getPikePaths(): Promise<import('./types.js').PikePathsResult> {
    return this.sendRequest<import('./types.js').PikePathsResult>(
      'get_pike_paths',
      {},
      (raw, method) => {
        const r = raw as Record<string, unknown>;
  ...
  async getInherited(className: string): Promise<import('./types.js').InheritedMembersResult> {
    const result = await this.sendRequest<import('./types.js').InheritedMembersResult>(
      'get_inherited',
      {
        class: className,
      }
  ...
  async resolveImport(
    ...
    return this.sendRequest<import('./types.js').ResolveImportResult>(
      'resolve_import',
      params,
      (raw, method) => {
        const r = raw as Record<string, unknown>;
  ...
  async getWaterfallSymbols(
    ...
    return this.sendRequest<import('./types.js').WaterfallSymbolsResult>(
  ...
  async findOccurrences(code: string): Promise<import('./types.js').FindOccurrencesResult> {
    return this.sendRequest<import('./types.js').FindOccurrencesResult>('find_occurrences', {
      code,
    });
  }
  ...
  async findRenamePositions(
    ...
    return this.sendRequest<import('./types.js').FindRenamePositionsResult>(
  ...
  async evaluateConstant(
    ...
    return this.sendRequest<{ success: number; value?: unknown; type?: string; error?: string }>(
      'evaluate_constant',
      {
        expression,
  ...
  private evictOldTokenCacheEntries(): void {
    ...
    const entries = Array.from(this.tokenCache.entries()).sort(
  ...
  async getCompletionContext(
    ...
    if (documentUri && documentVersion !== undefined) {
      ...
      if (cached && cached.version === documentVersion) {
        ...
        try {
          const result = await this.sendRequest<import('./types.js').CompletionContext>(
  ...
  async batchParse(
    ...
    if (files.length > BATCH_PARSE_MAX_SIZE) {
      ...
      for (const chunk of chunks) {
        ...
        const result = await this.sendRequest<import('./types.js').BatchParseResult>(
          'batch_parse',
          {
            files: chunk,
          }
  ...
  async getProtocolInfo(): Promise<ProtocolInfo | null> {
    this.debugLog('Getting protocol info via RPC...');
    try {
      const result = await this.sendRequest<ProtocolInfo>('get_protocol_info', {});
      return result;
    } catch (err) {
      const message = err instanceof Error ? err.message : String(err);
      this.debugLog(`getProtocolInfo failed: ${message}`);
      return null;
    }
  }
  ...
  async engineOpenDocument(params: {
    ...
    return this.sendRequest<QueryEngineMutationAck>('engine_open_document', params);
  }
  ...
  async engineChangeDocument(params: {
    ...
    return this.sendRequest<QueryEngineMutationAck>('engine_change_document', params);
  }

  async engineCloseDocument(params: { uri: string }): Promise<QueryEngineMutationAck> {
    return this.sendRequest<QueryEngineMutationAck>('engine_close_document', params);
  }

  async engineUpdateConfig(params: {
    settings: Record<string, unknown>;
  }): Promise<QueryEngineMutationAck> {
    return this.sendRequest<QueryEngineMutationAck>('engine_update_config', params);
  }
  ...
  async engineUpdateWorkspace(params: {
    ...
    return this.sendRequest<QueryEngineMutationAck>('engine_update_workspace', params);
  }
  ...
  async roxenGenerateSkeleton(
    ...
    return this.sendRequest<{ code: string; moduleType: string; moduleName: string }>(
  ...
  async roxenParseVars(
    ...
    return this.sendRequest<{ variables: import('./types.js').ModuleVariable[] }>(
      'roxen_parse_vars',
      params
    );
  }
  ...
  async roxenGetCallbacks(
    ...
    return this.sendRequest<{ lifecycle: import('./types.js').LifecycleInfo }>(
      'roxen_get_callbacks',
      params
    );
  }
  ...
  async roxenExtractRXMLStrings(
    ...
    return this.sendRequest<{ strings: import('./types.js').RXMLStringResult[] }>(
  ...
  async roxenGetTagCatalog(
    ...
    const result = await this.sendRequest<{ tags: import('./types.js').RXMLTagCatalogEntry[] }>(
  ...
  async invalidateCache(
    path: string,
    transitive = false
  ): Promise<import('./types.js').InvalidateCacheResult> {
