...
| --------------------------- | ------------------------------------------------------ | ------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RFC invariants adopted      | Active (Accepted), versioned invariants + criteria     | Enforced in code + tests                          | DONE        | `docs/specs/query-engine-v2-rfc.md`, `docs/specs/query-engine-v2-protocol-contract.v2.0.0.json`, `packages/pike-bridge/src/bridge.test.ts`, `packages/pike-lsp-server/src/testing/property-tests/query-engine-v2-rfc-invariants.test.ts`, `packages/pike-lsp-server/src/testing/stress-scenarios/revision-monotonicity.stress.test.ts`, `packages/pike-lsp-server/src/scenarios/fault-invariant.test.ts`, `.github/workflows/test.yml`                          |
...
| Parse-under-edit resilience | DONE: KB-1248 implemented for non-migrated paths       | Non-fatal incremental parse under rapid edits     | DONE        | `packages/pike-lsp-server/src/features/navigation/hover.ts`, `packages/pike-lsp-server/src/features/editing/signature-help.ts`, `packages/pike-lsp-server/src/features/advanced/code-actions.ts`, `packages/pike-lsp-server/src/scenarios/hover-parse-resilience.test.ts`, `packages/pike-lsp-server/src/scenarios/signature-help-parse-resilience.test.ts`, `packages/pike-lsp-server/src/scenarios/code-actions-parse-resilience.test.ts`                     |
