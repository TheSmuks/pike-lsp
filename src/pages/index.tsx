        ...
        <div style={{ padding: '2rem', backgroundColor: 'var(--ifm-background-surface-color)' }}>
          ...
          >
            ...
            >
              ...
              <p>
                Syntax highlighting, code completion, go to definition, find references, hover
            ...
            >
              ...
              <p>
                Comprehensive LSP support for Roxen WebServer framework including defvar extraction
                and RXML tag detection.
              </p>
              <Link to="/docs/features">Learn more →</Link>
            </div>
            <div
            ...
            >
              ...
              <p>
                Parses 1000+ line files in ~15ms with smart caching and batch parsing for fast
                workspace indexing.
              </p>
              <Link to="/docs/features">Learn more →</Link>
            </div>
