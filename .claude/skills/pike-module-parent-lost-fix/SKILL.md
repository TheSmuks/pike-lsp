...
**Remove the outer class wrapper.** In Pike, a `.pike` file inside a module directory _is_ the class definition itself. You do not need (and should not have) an explicit class wrapper around the content.
