...
<task type="auto">
  ...
  <verify>grep -c "protected.*function\|protected.*int" pike-scripts/LSP.pmod/Analysis.pike</verify>
  <done>All protected helper functions exist (should be ~20+ helpers after this task)</done>
</task>
